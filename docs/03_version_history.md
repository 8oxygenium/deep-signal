...
## v0.3.6 - Full Run Balance / Tempo Pass

概要:

- 新機能追加ではなく、STAGE 1〜8を通して遊ぶための難易度・テンポ・視認性調整
- STAGE 1〜3の敵弾頻度、暗さ、補給間隔を緩めて序盤の事故率を低減
- STAGE 4〜5でrammerと深層表現を本格化しつつ、暗さの上限を少し抑制
- rammerの予兆時間、輪郭表示、突撃速度を調整して回避余地を増加
